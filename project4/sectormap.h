...
#define SECTOR_SIZE		512	//섹터 사이즈	
#define SPARE_SIZE		16		//스페어 사이즈	
#define PAGE_SIZE			(SECTOR_SIZE+SPARE_SIZE)  //섹터사이즈와 스페어사이즈를 더하면 페이지 사이즈
#define SECTORS_PER_PAGE	1 //한 페이지당 섹터 한개
#define PAGES_PER_BLOCK		4 //한 블록당 섹터 4개
#define BLOCK_SIZE		(PAGE_SIZE*PAGES_PER_BLOCK) //한 블록 사이즈
#define BLOCKS_PER_DEVICE	2 // 상수값 수정 가능 //블록 개수
